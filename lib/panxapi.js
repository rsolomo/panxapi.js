...
Client.prototype.keygen = function(options, callback) {
  var self = this
  var hostname = options.hostname || this.hostname
  var queryObj = {
    type : 'keygen',
  ...
  var url = this.protocol + hostname + this.apiUrl + query
  ...
  this.rq(url, function(err, response, body) {
    if (err) {
      return callback(err)
    } 
...
Client.prototype.clone = function(options, callback) {
  ...
  if (typeof options.from === 'undefined') {
    throw new TypeError('options.from is a required argument')
  }
 ...
 * @public
 */
Client.prototype.report = function(options, callback) {
  if (typeof options.reporttype === 'undefined') {
    throw new TypeError('options.reporttype is a required argument')
  }
...
Client.prototype.createUrl = function(options, callback) {
  ...
  var url = this.protocol + this.hostname + this.apiUrl + query
  this.sendRequest(url, function(err, xml) {
    return callback(err, xml)
  })
}
 ...
 * @private
 */
Client.prototype.sendRequest = function(url, callback) {
  this.rq(url, function(err, response, body) {
    if (err) {
      return callback(err, null)
    } 
